...
public class ConfigUtil {
    ...
    public static final String TRANSLATOR_CLASS = "datalake.translator_class";

    public static final String TEMPORARY_HFILE_PATH = "datalake.import.tmp_hfile_path";

    public static final String SHOULD_PRESPLIT_TABLE = "datalake.import.presplit_table";

    public static final String PRESPLIT_TABLE_REGION_SIZE = "datalake.import.resplit_table_chunk_size";

    public static final String MERGE_EXISTING_TABLE = "datalake.import.merge_existing";

    public static final String SKIP_BACKLOG = "datalake.tailer.skip_backlog";

    public static final String SKIP_UPDATES = "datalake.tailer.skip_updates";

    public static final String SKIP_DELETES = "datalake.tailer.skip_deletes";

    public static final String BUFFER_WRITES = "datalake.tailer.buffer_writes";

    public static final String TAILER_STATE_TABLE = "datalake.tailer.state_table";

    public static final String DEFAULT_TEMPORARY_HFILE_PATH = "/tmp/datalake_hfile_out";
